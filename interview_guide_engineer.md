...
すべてのプロセスはオンライン(ZoomまたはGoogle Meet)で行われます。面接用のURLは事前に人事より連絡します。
...
[2次面接](#2次面接) | CTO または エンジニアリング部 副部長 | 60分 | エンジニアリング部で一緒に働くメンバーとして、カルチャーフィットするかどうか、お任せする予定の仕事で期待する成果が出せそうかをソフトスキル・技術の両面から判断します。
[最終面接](#最終面接) | COO / 人事 | 60分 | Kyashで一緒に働くメンバーとして、お互いにミスマッチがなく働けるか、カルチャーマッチ観点を含めた双方向の確認をします。
[オファー面談](#オファー面談) | CTO / 人事 | 30分 | 面接を経てオファーを出させていただいた方に、期待する役割や条件、今後の事業や組織の展望などを伝え、応募者の最終判断に必要なすり合わせを行います。
...
エンジニアリング部で一緒に働くメンバーとして、カルチャーフィットするかどうか、お任せする予定の仕事で期待する成果が出せそうかをソフトスキル・技術の両面から見極めるのが目的です。  
今後一緒に開発していく上で、プロダクトに対する興味やマインドセットも重視して確認させていただきます。

### 出席者

CTO または エンジニアリング部 副部長
