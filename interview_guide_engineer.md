...
選考 | 出席者 | 最大時間 | 目的
:--: | :--: | :--: | :--
[書類選考](https://github.com/Kyash/recruitment/blob/master/interview_guide_engineer.md#%E6%9B%B8%E9%A1%9E%E9%81%B8%E8%80%83) | EM 1名 | N/A | それぞれの職種の募集要項の `必須の経験・スキル` を満たしているかを確認いたします。
...
履歴書・職務経歴書の2つの書類データの提出をお願いいたします。書類のフォーマットは問いません。また履歴書の顔写真の掲載も必須ではありません。
...
社名のみの記載など情報が不足している場合には選考を致しかねる場合がございます。
またプライベートで行った開発や執筆した記事などで見てもらいたいものがあれば職務経歴書に併せて記載してください。

### 目的

それぞれの職種の募集要項の `必須の経験・スキル` を満たしているかを確認いたします。
経験が無い、あるいは極端に不足していないかどうかを確認するためのもので具体的な技術経験・スキルは1次面接で判断いたします。
